...
{
    // Outlet
    public static MazeLevelController instance;
    // Configuration
    public int level = 1;
    public int playerClass = 5;
    ...
    void Awake()
    {
        ...
        seed = (int)GameContext_Seed.MazeSeed;
        ...
        GameContext_Seed.MazeInitFromLevel(this);
        Debug.Log($"MazeSeed = {GameContext_Seed.MazeSeed}");
    }
